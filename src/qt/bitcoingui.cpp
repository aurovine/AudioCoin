...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About audiocoin"), this);
    ...
    optionsAction->setToolTip(tr("Modify configuration options for audiocoin"));
...
void BitcoinGUI::createToolBars()
{
    ...
    mainIcon->setPixmap(QPixmap(":images/grow-vertical"));
    mainIcon->show();
...
void BitcoinGUI::mainToolbarOrientation(Qt::Orientation orientation)
{
    ...
    {
        mainIcon->setPixmap(QPixmap(":images/grow-horizontal"));
        mainIcon->show();
