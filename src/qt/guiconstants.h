...
#define INPUT_STYLE_INVALID "QLineEdit { font-family: 'Open Sans'; font-size: 13px; border: none; border-bottom: 2px solid red; padding: 3px 5px; background: transparent; }"
