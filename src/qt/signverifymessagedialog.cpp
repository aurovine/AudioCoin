    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter an audiocoin address (e.g. SXywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter an audiocoin address (e.g. SXywGBZBowrppUwwNUo1GCRDTibzJi7g2M)"));
