...
const string strMessageMagic = "audiocoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    else if(nHeight <= 131040)
    {
        nSubsidy = 1600 * COIN;
    }

    else if(nHeight <= 141120)
    {
        nSubsidy = 1400 * COIN;
    }
    ...
    else if(nHeight <= 171360)
    {
        nSubsidy = 800 * COIN;
    }

    else if(nHeight <= 181440)
    {
        nSubsidy = 600 * COIN;
    }

    else if(nHeight <= 191520)
    {
        nSubsidy = 400 * COIN;
    }
...
// audiocoin: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "audiocoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        */
        ...
        const char* pszTimestamp = "aurovine goes live";
        CTransaction txNew;
        txNew.nTime = 1417617640;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        if (false && (block.GetHash() != hashGenesisBlock)) {
            ...
            printf("block.nNonce = %u \n", block.nNonce);
                ...
                //// debug print
                assert(block.hashMerkleRoot == uint256("0x77e4b157ed08be1836b38295aefc49da8608431dd0407df8f52ca492ca3266dc"));
                block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xf4, 0xfb, 0xff };
